crypt("This JavaScript program encrypts and decrypts messages using the Vigenere cipher.", "WebStorm", false);
crypt("Vljk IommUgsaih gdkkssf seoncqll oep zidjrdke iitktuve qwjfz hyq Xmhwgsiq ymqzxf.", "WebStorm", true);
        ...
        if(input[idx].toUpperCase() !== input[idx].toLowerCase()){
            ...
            if(input[idx] === input[idx].toUpperCase()){
                if(decrypt){
                    ...
                    encrypted_letter_code = (((crypt_letter_code-65) - (key_letter_code-65)) % 26);
                    ...
                    encrypted_letter_code = (((crypt_letter_code-65) + (key_letter_code-65)) % 26);
                    console.log(encrypted_letter_code)
                    output += String.fromCharCode(encrypted_letter_code+65);
                }
                key_idx++;
            }
